            ...
            if (isCollection) {
                ...
                if (data != null) {
                    String dataValueLink = _tradeManager.push(_modelReference.getNamespaceURI(), _modelReference.getLocalName
                            ...
                            getContentType(fileNameTemplate), "opalCLUS-WebService-Wrapper#", _index);
                ...
                if (data != null) {
                    String dataValueLink = _tradeManager.push(_modelReference.getNamespaceURI(), _modelReference.getLocalName
                            (), elementRef.getDataObjectName(), elementRef.getDataElementName(), isCollection, data, getContentType(fileNameTemplate),"opalCLUS-WebService-Wrapper#", null);
