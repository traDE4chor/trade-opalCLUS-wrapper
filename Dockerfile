...
ADD opalclusarg ${OPAL_EXEC}
WORKDIR ${OPAL_EXEC}
RUN chmod -R a+x *

EXPOSE 8080

COPY --from=builder /opt/opal/target/opalCLUS.war ${CATALINA_HOME}/webapps
...
#
#   docker build -t trade4chor/opalclus-service-wrapper .
#
# 
